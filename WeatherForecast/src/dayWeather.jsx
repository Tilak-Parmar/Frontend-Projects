...
constructor(props){
  ...
  render() {
    console.log("on nex page:" + this.state.city);  
    ...
    return(
        <div className="mainDiv">
            <div>
                ...
                <div className="displayData">Hourly Weather Forecast on {weekDay[(selectedDate.getDay())] + " " + months[(selectedDate.getMonth())] +" "+(selectedDate.getDate()) + ", " + (selectedDate.getFullYear())}</div>
            </div>
    ...
    weatherElementsBlock.push(
        <div className="weatherElementsHourly">
            ...
            <div>
                ...
                <div className="humidity valueSpan">&nbsp;{weatherWind} mph</div>
            </div>
        </div>
        </div>
