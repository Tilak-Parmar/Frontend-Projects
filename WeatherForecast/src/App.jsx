...
class App extends Component {
  ...
  constructor(props){
    ...
    this.state = {
            weather: [
                        {day:'Monday',temperatur:25, min:23, max:27, wind:'12mph',type:'sunny',humidity:'59%'},
                        {day:'Tuesday',temperatur:25, min:23, max:27, wind:'12mph',type:'snowy',humidity:'59%'},
                        {day:'Wednesday',temperatur:25, min:23, max:27, wind:'12mph',type:'rainy',humidity:'59%'},
                        {day:'Thursday',temperatur:25, min:23, max:27, wind:'12mph',type:'sunny',humidity:'59%'},
                        {day:'Friday',temperatur:25, min:23, max:27, wind:'12mph',type:'cloudy',humidity:'59%'},
                    ],
            weatherData : [],
            city: 'Boston',
            dispCity:'Boston',
    ...
    componentDidMount(){
      ...
      var url = "http://api.openweathermap.org/data/2.5/forecast?q=Boston,us&appid="+api_key;
  ...
  createDropDown = () => {
    return(
      ...
      <button onClick={this.getLoctionWeather}><b>GO</b></button>
  ...
  createBlock = () => {
      ...
      var dateDisplay = months[new Date(dateStr).getMonth()] + " " + (new Date(dateStr).getDate()) + ", " + (new Date(dateStr).getFullYear());
      ...
      return(
        ...
        <div className="mainDivContent">
          <h1 className="applicationHeading">United States 5-Day Weather</h1>
          <div>
            <h1 className="mainDivElemHead">{this.state.dispCity.toUpperCase()}</h1>
                        {this.createDropDown()}
          </div>
          <br/><br/><br/>
          <div>
  ...
  createWeatherBlocks = () => {
    ...
    for(var i=0;i<this.state.weatherData.list.length;i++){
      ...
      var weatherDay = weekDay[(new Date(dateStr))];
